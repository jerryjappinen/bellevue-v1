...
describe('Util trimWhitespace with trailing whitespace', function () {
	...
	for (let key in whitespaceStrings) {
		it('should trim ' + key, function () {
			...
			expect(trimWhitespace(expectedResult + whitespaceStrings[key])).to.equal(expectedResult);
...
describe('Util trimWhitespace with leading whitespace', function () {
	...
	for (let key in whitespaceStrings) {
		it('should trim ' + key, function () {
			...
			expect(trimWhitespace(whitespaceStrings[key] + expectedResult)).to.equal(expectedResult);
...
describe('Util trimWhitespace with excess whitespace', function () {
	...
	for (let key in whitespaceStrings) {
		it('should trim ' + key, function () {
			...
			expect(trimWhitespace(partOne + whitespaceStrings[key] + partTwo)).to.equal(expectedResult);
